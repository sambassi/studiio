      ...
      if (isBatch) {
          ...
          try {
            ...
            const composePromise = composeAndUpload({
              ...
              design: {
                ...
                logoPosition: (batchDesign.positions as Record<string, { x?: number; y?: number }>)?.logo || undefined,
                ...
                titlePosition: (batchDesign.positions as Record<string, { x?: number; y?: number }>)?.title || undefined,
                cardsPosition: (batchDesign.positions as Record<string, { x?: number; y?: number }>)?.cards || undefined,
                cardsSize: ((batchDesign.sizes as Record<string, number>) || {}).cards || undefined,
                ctaMainText: (batchDesign.ctaMainText as string) || undefined,
                ctaSubTextDesign: (batchDesign.ctaSubText as string) || undefined,
                titleTypography: ((batchDesign.typography as Record<string, unknown>) || {}).title as { letterSpacing?: number; lineHeight?: number; bold?: boolean; italic?: boolean } || undefined,
              },
              sharedAudioCtx,
              musicBuffer,
              voiceBuffer,
        ...
        const result = await composeAndUpload({
          ...
          design: {
            ...
            logoPosition: (pDesign.positions as Record<string, { x?: number; y?: number }>)?.logo || undefined,
            ...
            titlePosition: (pDesign.positions as Record<string, { x?: number; y?: number }>)?.title || undefined,
            cardsPosition: (pDesign.positions as Record<string, { x?: number; y?: number }>)?.cards || undefined,
            cardsSize: ((pDesign.sizes as Record<string, number>) || {}).cards || undefined,
            ctaMainText: (pDesign.ctaMainText as string) || undefined,
            ctaSubTextDesign: (pDesign.ctaSubText as string) || undefined,
            titleTypography: ((pDesign.typography as Record<string, unknown>) || {}).title as { letterSpacing?: number; lineHeight?: number; bold?: boolean; italic?: boolean } || undefined,
          },
          sharedAudioCtx,
          musicBuffer,
          voiceBuffer,
