    ...
    try {
      ...
      if (isBatch) {
        ...
        for (let i = 0; i < posts.length; i++) {
          ...
          try {
            ...
            const composePromise = composeAndUpload({
              ...
              design: (() => {
                const positions = (batchDesign.positions as Record<string, { x?: number; y?: number }> | undefined) || {};
                const sizes = (batchDesign.sizes as Record<string, number> | undefined) || {};
                const typography = (batchDesign.typography as Record<string, { letterSpacing?: number; lineHeight?: number; bold?: boolean; italic?: boolean; textGradient?: boolean; gradColor1?: string; gradColor2?: string; duplicate?: boolean; duplicateOffset?: number; duplicateOpacity?: number }> | undefined) || {};
                return {
                  font: (batchDesign.font as string) || undefined,
                  filter: (batchDesign.filter as string) || undefined,
                  titleColor: (batchDesign.titleColor as string) || undefined,
                  gradientColor1: (batchDesign.gradientColor1 as string) || undefined,
                  gradientColor2: (batchDesign.gradientColor2 as string) || undefined,
                  gradientOpacity: (batchDesign.gradientOpacity as number) ?? undefined,
                  seqGradients: (batchDesign.seqGradients as Record<string, { enabled?: boolean; color1?: string; color2?: string; opacity?: number; position?: 'top' | 'bottom' | 'left' | 'right' | 'both' }>) || undefined,
                  noColorBg: (batchDesign.noColorBg as boolean) || undefined,
                  noColorSequences: (batchDesign.noColorSequences as string[]) || undefined,
                  ctaSubColor: (batchDesign.ctaSubColor as string) || (brand?.ctaSubColor as string) || undefined,
                  ctaColor: (batchDesign.ctaColor as string) || undefined,
                  ctaMainText: (batchDesign.ctaMainText as string) || undefined,
                  ctaSubTextDesign: (batchDesign.ctaSubText as string) || undefined,
                  logoSequences: (batchDesign.logoSequences as string[]) || undefined,
                  logoPosition: positions.logo || undefined,
                  logoPositions: (batchDesign.logoPositions as Record<string, { x?: number; y?: number }>) || undefined,
                  logoScale: (batchDesign.logoScale as number) || undefined,
                  overlayText: (pm.videoOverlayText as string) || undefined,
                  overlayColor: (batchDesign.overlayColor as string) || undefined,
                  textScale: (batchDesign.textScale as number) || undefined,
                  ctaTextScale: (batchDesign.ctaTextScale as number) || undefined,
                  cardStyle: (batchDesign.cardStyle as string) || undefined,
                  titlePosition: positions.title || undefined,
                  cardsPosition: positions.cards || undefined,
                  watermarkPosition: positions.watermark || undefined,
                  overlayPosition: positions.overlay || undefined,
                  titleSize: sizes.title || undefined,
                  cardsSize: sizes.cards || undefined,
                  watermarkSize: sizes.watermark || undefined,
                  titleTypography: typography.title || undefined,
                  ctaTypography: typography.cta || undefined,
                  overlayTypography: typography.overlay || undefined,
                };
              })(),
              sharedAudioCtx,
              musicBuffer,
        ...
        const result = await composeAndUpload({
          ...
          design: (() => {
            const positions = (pDesign.positions as Record<string, { x?: number; y?: number }> | undefined) || {};
            const sizes = (pDesign.sizes as Record<string, number> | undefined) || {};
            const typography = (pDesign.typography as Record<string, { letterSpacing?: number; lineHeight?: number; bold?: boolean; italic?: boolean; textGradient?: boolean; gradColor1?: string; gradColor2?: string; duplicate?: boolean; duplicateOffset?: number; duplicateOpacity?: number }> | undefined) || {};
            return {
              font: (pDesign.font as string) || undefined,
              filter: (pDesign.filter as string) || undefined,
              titleColor: (pDesign.titleColor as string) || undefined,
              gradientColor1: (pDesign.gradientColor1 as string) || undefined,
              gradientColor2: (pDesign.gradientColor2 as string) || undefined,
              gradientOpacity: (pDesign.gradientOpacity as number) ?? undefined,
              seqGradients: (pDesign.seqGradients as Record<string, { enabled?: boolean; color1?: string; color2?: string; opacity?: number; position?: 'top' | 'bottom' | 'left' | 'right' | 'both' }>) || undefined,
              noColorBg: (pDesign.noColorBg as boolean) || undefined,
              noColorSequences: (pDesign.noColorSequences as string[]) || undefined,
              ctaSubColor: (pDesign.ctaSubColor as string) || (brand?.ctaSubColor as string) || undefined,
              ctaColor: (pDesign.ctaColor as string) || undefined,
              ctaMainText: (pDesign.ctaMainText as string) || undefined,
              ctaSubTextDesign: (pDesign.ctaSubText as string) || undefined,
              logoSequences: (pDesign.logoSequences as string[]) || undefined,
              logoPosition: positions.logo || undefined,
              logoPositions: (pDesign.logoPositions as Record<string, { x?: number; y?: number }>) || undefined,
              logoScale: (pDesign.logoScale as number) || undefined,
              overlayText: (pm.videoOverlayText as string) || undefined,
              overlayColor: (pDesign.overlayColor as string) || undefined,
              textScale: (pDesign.textScale as number) || undefined,
              ctaTextScale: (pDesign.ctaTextScale as number) || undefined,
              cardStyle: (pDesign.cardStyle as string) || undefined,
              // Per-sequence positions — were missing for watermark / overlay,
              // making CTA jump to default (50/97) and overlay to (50/33) on
              // every Studio Son re-export.
              titlePosition: positions.title || undefined,
              cardsPosition: positions.cards || undefined,
              watermarkPosition: positions.watermark || undefined,
              overlayPosition: positions.overlay || undefined,
