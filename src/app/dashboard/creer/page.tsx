...
import {
  ...
  Clipboard, ClipboardList, FileText, File as FileIcon, Folder, FolderOpen, Archive, Inbox, Mail, MessageSquare, MessageCircle, Send as SendIcon,
...
const ICON_MAP: Record<string, LucideIcon> = {
  ...
  CloudRain, CloudSnow, Snowflake, Wind, Umbrella, Rainbow,
  Gamepad2, Joystick, Puzzle,
  Clipboard, ClipboardList, FileText, File: FileIcon, Folder, FolderOpen, Archive, Inbox, Mail, MessageSquare, MessageCircle, Send: SendIcon,
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      for (let b = 0; b < total; b++) {
        ...
        // SURFACE ERRORS WITHOUT BREAKING THE LOOP — sans ce wrapper, une
        // exception silencieuse dans une itération sort à l'OUTER catch de
        // handleExport et termine TOUT l'export (raison pour laquelle batch
        // x3 produit 2 posts : b=2 throw → boucle terminée). Avec ce try
        // par itération : l'erreur est loguée + toast affiché, et la boucle
        // continue avec l'itération suivante.
        try {
